...
public class ALNS
{
    ...
    public ALNS(int seed = 2025)
    {
        // Se seed tiver valor, usa para inicializar; caso contrário, usa semente padrão (null = novo Random())
        _random = new Random(seed);
    }

    public List<List<int>> AdaptiveLargeNeighborhoodSearch(
        ProblemData problemData,
        int maxIterations = 3500000, //3500000
        int maxNoImprovement = 1000000, //1000000
        double initialTemperature = 20000.0, //20000.0
        double coolingRate = 0.9998) //0.999
    {
